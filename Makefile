...
SRCPREC = $(SRCDIR)/preconditioning.f
SRCPRER = $(SRCDIR)/pre_regularization.f
...
OBJPREC = $(OBJDIR)/preconditioning.o
OBJPRER = $(OBJDIR)/pre_regularization.o
...
$(OBJPREC): $(SRCPREC)
	    $(FC) $(CFLAGS) $(SRCPREC) -o $(OBJPREC)

$(OBJPRER): $(SRCPRER)
	    $(FC) $(CFLAGS) $(SRCPRER) -o $(OBJPRER)
