...
% STEP A - Particle tracing algorithm - Adam-Bashforth 3, for t0-t1
    [XDGgt1,YDGgt1] = AB3(X,Y,U,V,XDGgt1,YDGgt1,dt);

% STEP C. 1-3 for t0-t1
    ...
    XDGgt1 = lagrange_2D_interpoaltion(ep,et,XDGlt1,YDGlt1,XDGgt1,Nx,Ny);
    YDGgt1 = lagrange_2D_interpoaltion(ep,et,XDGlt1,YDGlt1,YDGgt1,Nx,Ny);
end
XDGgt2 = XDGgt1;
YDGgt2 = YDGgt1;
for t=1:NT

% STEP A - Particle tracing algorithm - Adam-Bashforth 3, for t1-t2
    [XDGgt2,YDGgt2] = AB3(X,Y,U,V,XDGgt2,YDGgt2,dt);

% STEP C. 1-3 for t1-t2
    %Computing parametrizations
    xb1 = XDGgt2(1,:);   yb1 = YDGgt2(1,:);
    xb2 = XDGgt2(:,end); yb2 = YDGgt2(:,end);
    xb3 = XDGgt2(end,:); yb3 = YDGgt2(end,:);
    xb4 = XDGgt2(:,1);   yb4 = YDGgt2(:,1);
    [ppgx,ppgy,ppgpx,ppgpy] = param(ep,et,xb1,xb2,xb3,xb4,yb1,yb2,yb3,yb4);
    
    %Mapping to local element
    x1 = [XDGgt2(1,1); YDGgt2(1,1)];
    x2 = [XDGgt2(1,end); YDGgt2(1,end)];
    x3 = [XDGgt2(end,end); YDGgt2(end,end)];
    x4 = [XDGgt2(end,1); YDGgt2(end,1)];
    [XDGlt2,YDGlt2] = map_to_local(ep,et,XDGgt2,YDGgt2,ppgx,ppgy,ppgpx,ppgpy,x1,x2,x3,x4);
    
    %Evaluating the interpolation Ipp.^-1 (here PSI = [XDGgt2,YDGgt2] and THETA = [XDGgt0,YDGgt0] is computed
    % [XDGgt2,YDGgt2] = interpol(ep,et,XDGlt1,YDGlt1,XDGgt2,YDGgt2);
    % [XDGgt0,YDGgt0] = interpol(ep,et,XDGlt1,YDGlt1,XDGgt0,YDGgt0);
    XDGgt2 = lagrange_2D_interpoaltion(ep,et,XDGlt2,YDGlt2,XDGgt2,Nx,Ny);
    YDGgt2 = lagrange_2D_interpoaltion(ep,et,XDGlt2,YDGlt2,YDGgt2,Nx,Ny);
end
