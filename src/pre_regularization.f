...
!
      DO I = 1,SING
        CALL CSC_PCG(LMT,B,UL,MNITERM,TOLSING,LUVR,DLMR,PCS,NIT,RESS)
        UL = UL*(1D0/NORM2(UL))
      ENDDO 
!
...
!
      DO I = 1,SING
        CALL CSC_BICGSTAB(LMT,B,UL,MNITERM,TOLSING,LUVR,DLMR,PCS,NIT,
     &                    RESS)
        UL = UL*(1D0/NORM2(UL))
      ENDDO 
!
...
!
      DO I = 1,SING
        CALL CSC_GMRES(LMT,B,UL,KSSS,MNITERM,TOLSING,LUVR,DLMR,PCS,
     &                 NIT,RESS)
        UL = UL*(1D0/NORM2(UL))
      ENDDO 
!
...
!
     ...
     &    MAXVAL(ABS(UL))
      WRITE(*,*) 'INFINITE NORM OF RHS SINGULAR VECTOR (VL): ',
     &    MAXVAL(ABS(VL))
