...
!
      IF(DEBUG) WRITE(*,*) 'GOING INTO PRECONDITIONING'
      CALL PRECONDITIONING(LM,KM,PCD,WSSORD,PCS,WSSORS,SOLP,PCP,WSSORP,
     &                      W,LPM,LQM)
      IF(DEBUG) WRITE(*,*) 'EXIT PRECONDITIONING'
!
!  COMPUTING REGULARIZATION MATRIX, AND PREPARING ENTRIES FOR SOR SOLVER
!
      IF(DEBUG) WRITE(*,*) 'GOING INTO PRE_REGULARIZATION'
      CALL PRE_REGULARIZATION(LM,SOLSING,PCS,KSSS,SING,TOLSING,MNITERM,
     &    LUVR,DLMR,UL,VL)
      IF(DEBUG) WRITE(*,*) 'EXIT PRE_REGULARIZATION'
!
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  TIME LOOP
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!
      ...
      CALL POISSON(LM,DUPDX,DVPDY,UL,SOLP,PCP,KSSP,LUVP,DLM,LPM,LQM,
     &             MNITERS,NITS,TOLSOR,TIEP,P,PP,FRESP)
...
!
      ...
      CALL DIFFUSION(U,V,UO,VO,UPP,VPP,SX,SY,KM,PCD,LUVD,DKM,MNITERD,
     &  NTIDX,NTIDY,TOLCG,BOUND,UPBOUND,DOBOUND,LEBOUND,RIBOUND,
     &  UPBOUNDI,DOBOUNDI,LEBOUNDI,RIBOUNDI,FRESDX,FRESDY)
